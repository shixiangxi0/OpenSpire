...
export const vulnerable = {
  ...
  hooks: {
    ...
    'event:entity:attack': { order: 100, match: { target: 'self' }, script: `
...
export const ritual = {
  ...
  hooks: { 'event:actor:turn:end': { order: 400, match: { target: 'self' }, script: `
...
export const rupture = {
  ...
  hooks: { 'event:entity:loss': { order: -100, match: { target: 'self' }, script: `
...
export const poison = {
  ...
  hooks: {
    ...
    'event:actor:turn:end': { order: 600, match: { target: 'self' }, script: `
...
export const thorns = {
  ...
  hooks: { 'event:entity:attack': { order: -200, match: { target: 'self' }, script: `
...
export const frail = {
  ...
  hooks: {
    ...
    'event:entity:block': { order: 100, match: { target: 'self' }, script: `
...
export const block = {
  ...
  hooks: {
    'event:actor:turn:start': { match: { target: 'self' }, script: `
